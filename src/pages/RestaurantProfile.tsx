                ...
                generateArray(5).map((i) => {
                  if ((i) <= restaurantDetails?.average_rating) {
                    return (
                      ...
                      <input type="radio" name={restaurantDetails?.id + "avgrating"} className="mask mask-heart bg-orange-400" disabled checked readOnly />
                    )
                  }
                  else {
                    return (<input type="radio" name={restaurantDetails?.id + "avgrating"} className="mask mask-heart bg-orange-400" disabled readOnly />)
                  }
                })
              }
                      ...
                      <div className="rating rating-sm">
                        {
                          [1, 2, 3, 4, 5].map((i) => {
                            return (
                              <input type="radio" name={review.id + "userreview"} className="mask mask-heart bg-orange-400" checked={i == review.rating} disabled />
                            )
                          })
                        }
                      </div>
