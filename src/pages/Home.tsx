...
import me from '../assets/team/pratyus.jpg';
import pranay from '../assets/team/pranay.jpg';
import sabib from '../assets/team/sabib.jpg';
...
const Home = () => {
  ...
  const teamMembers = [
    { id: 1, name: 'Pratyus Oli', role: 'Backend', imageUrl: me },
    { id: 2, name: 'Pranaya Gurung', role: 'Frontend', imageUrl: pranay },
    { id: 3, name: 'Sabib Maharjan', role: 'Frontend', imageUrl: sabib },
  ];
          ...
          <section className="py-12">
            <div className="text-center mb-16">
              ...
              <p className="text-lg mt-2">
                TasteYatra is a webapp that helps users discover delicious food at local restaurants and small businesses.
              </p>
            </div>
            ...
            <div className="mx-auto mb-12">
              ...
              <p className="text-lg">
                TasteYatra's mission is to connect people with quality food experiences by helping them find the perfect place to dine, based on their preferences and location.
              </p>
            </div>
