    ...
    return (
        <>
            ...
            <nav className="flex justify-between items-center px-4 py-2">
                <Link to="/"> <p className="font-extrabold text-2xl mr-20"> TasteYatra </p></Link>
                ...
                {user === null ?
                    ...
                    <>
                        ...
                        {/* Theme Toggle */}
                        <div className="flex-none mr-2 md:mr-4 md:ml-4">
                ...
                {user !== null && (
                    <div className="flex-none mr-12">
                        <button className=" block lg:hidden btn btn-square btn-ghost" onClick={toggleMenu}>
                ...
                {user !== null && (
                    <div className={`lg:hidden fixed border-l-4 border-bumblebee top-0 right-0 h-full z-50 transition-transform duration-500 transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} ${theme === 'dracula' ? 'bg-gray-800' : 'bg-white'}`} style={{ width: '230px' }}>
                        ...
                        <div className="mx-1 my-5">
                            <Link to="/"> <p className="font-extrabold text-2xl">TasteYatra</p> </Link>
